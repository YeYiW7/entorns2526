...
El backend serà el car del sistema, encarregat de gestionar dades, usuaris, i la lògica del sistema.
...
- Còpies de seguretat autinàtiques
...
- Seguretat password: md5 , sha256 o sha 512
...
- IDE's: VScode Python, Androis Studio, PyCharm
